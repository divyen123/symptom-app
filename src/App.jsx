...
function PPGScannerModal({ onClose, onApply }) {
  ...
  // 3. finalizeScan (depends on stopCamera, setFinalBpm, setFinalSpo2, updatePhase)
...
const phaseColor = phase === "done" ? "#10b981"
    : phase === "scanning" ? "#22d3ee"
    : phase === "calibrating" ? "#f59e0b"
    : "var(--text-red-light)";

  const phaseLabel = phase === "done" ? "SCAN COMPLETE"
    : phase === "scanning" ? `SCANNING… ${countdown}s`
    : phase === "calibrating" ? "CALIBRATING…"
    : phase === "waiting" ? "WAITING FOR FINGER"
    : "INITIALIZING…";
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          borderRadius: 20,
          boxShadow: `0 32px 80px rgba(0,0,0,0.6), 0 0 60px ${phaseColor}15`,
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 10, fontWeight: 800, color: phaseColor, letterSpacing: "0.15em", textTransform: "uppercase" }}>
              📡 PPG Vitals Scanner
            </div>
            <div style={{ fontSize: 17, fontWeight: 900, color: "#e2e8f0", marginTop: 4, letterSpacing: "-0.3px" }}>
              {phase === "done" ? "Results Ready" : "Camera Pulse Analysis"}
            </div>
          </div>
          <button onClick={() => { stopCamera(); onClose(); }} style={{
            background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)",
            color: "var(--text-faint)", width: 32, height: 32, borderRadius: 8,
        ...
        {phase !== "done" ? (
          <div style={{ padding: "20px 24px 24px" }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ fontSize: 11, fontWeight: 800, color: phaseColor, letterSpacing: "0.08em" }}>
                  {phaseLabel}
                </span>
              </div>
            </div>
            ...
            <div style={{
              ...
              boxShadow: `0 0 30px ${phaseColor}20, inset 0 0 20px rgba(0,0,0,0.4)`,
            }}>
              ...
              <svg style={{ position: "absolute", inset: -4, width: "calc(100% + 8px)", height: "calc(100% + 8px)" }} viewBox="0 0 100 100">
                <circle cx="50" cy="50" r="46" fill="none"
                  ...
                  strokeDasharray={phase === "scanning" ? "20 10" : "5 5"}
            ...
            <div style={{
              ...
              {phase === "waiting" || phase === "idle"
                ? "Firmly place your index finger over the camera lens and flash. Ensure the lens is completely covered."
                : phase === "calibrating"
                ? "Finger detected! Hold still while we lock onto your pulse signal…"
                : "Great signal! Keep your finger steady until the scan completes."
              }
            </div>
            ...
            {phase === "scanning" && liveBpm > 0 && (
              <div style={{
                ...
                <div style={{ textAlign: "center" }}>
                  ...
                  <div style={{ fontSize: 10, fontWeight: 700, color: "var(--text-muted)", letterSpacing: "0.1em", marginTop: 2 }}>BPM</div>
                </div>
              </div>
            )}
            ...
            <div style={{
              ...
              <canvas ref={waveRef} width={390} height={100}
          ...
          <div style={{ padding: "24px 24px 28px" }}>
            ...
            <div style={{ textAlign: "center", marginBottom: 24 }}>
              ...
              <div style={{ fontSize: 12, color: "var(--text-muted)", marginTop: 4 }}>
                Your vital readings have been calculated from the PPG signal
              </div>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 24 }}>
              ...
              <div style={{
                ...
                <div style={{ fontSize: 10, fontWeight: 700, color: "var(--text-muted)", letterSpacing: "0.1em", marginTop: 4 }}>
                  HEART RATE (BPM)
                </div>
              </div>
              {/* SpO2 */}
              <div style={{
                ...
                <div style={{ fontSize: 28, marginBottom: 6 }}>🫁</div>
                <div style={{
                  fontSize: 32, fontWeight: 900, color: "var(--green)",
                  fontFamily: "var(--font-mono, monospace)",
                  letterSpacing: "-1px",
            ...
            <div style={{
              ...
              borderRadius: 8,
              fontSize: 10.5, color: "var(--text-amber)", lineHeight: 1.55,
            }}>
              ⚠️ These readings are approximate estimates using camera-based photoplethysmography.
              For clinical accuracy, use a certified pulse oximeter. Always consult a physician.
            </div>
          </div>
        )}
          ...
          <form onSubmit={handleSave} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <button
              ...
              style={{
                ...
                color: "var(--scan-cyan)", border: "1.5px solid var(--scan-cyan-border)",
                borderRadius: "var(--radius-sm)",
                fontSize: 13.5, fontWeight: 800, cursor: "pointer",
                fontFamily: "var(--font)", marginTop: 4,
                boxShadow: "0 4px 16px var(--scan-cyan-glow)",
                display: "flex", alignItems: "center", justifyContent: "center", gap: 8,
                transition: "var(--transition)",
                letterSpacing: "-0.2px",
              }}
              onMouseEnter={e => { e.currentTarget.style.boxShadow = '0 6px 24px var(--scan-cyan-glow)'; e.currentTarget.style.borderColor = 'var(--scan-cyan)'; }}
              onMouseLeave={e => { e.currentTarget.style.boxShadow = '0 4px 16px var(--scan-cyan-glow)'; e.currentTarget.style.borderColor = 'var(--scan-cyan-border)'; }}
            >
              <span style={{ fontSize: 16 }}>📷</span>
              Finger Scan (Pulse & SpO₂)
            </button>
            ...
            <Card style={{ animation: "mtSlideIn 0.3s ease both" }}>
              ...
              {contacts.filter(c => c.name || c.phone).length > 0 && (
                <div style={{ marginBottom: 16 }}>
                  ...
                  <div style={{ maxHeight: "360px", overflowY: "auto", paddingRight: 6, display: "flex", flexDirection: "column", gap: 6 }}>
                    {contacts.map((c, i) => {
            ...
            <div style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 18, padding: 24, textAlign: "left" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                {recommendations.herbs?.map((h, idx) => (
                  <div key={idx} style={{ background: "var(--surface-2)", borderRadius: 12, padding: 16, border: "1px solid var(--border)" }}>
                    <div style={{ fontWeight: 700, fontSize: 14, color: "var(--navy)", marginBottom: 4 }}>{h.name}</div>
            ...
            {filteredItems.map((item, i) => (
              ...
              >
                <div style={{ flex: 1, textAlign: "left" }}>
                  <h4 style={{ margin: "0 0 6px", fontSize: 15, fontWeight: 800, color: "var(--navy)" }}>{item.name}</h4>
